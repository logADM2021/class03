...
**Grupo 1:** Isabela Costa; Gabriela Lopes; Wallace Domiciano; Cristiano Messeder  

**Grupo 2:** Filipe Mendes, Gabriela Pereira, Valéria Gomes e Thais Gonçalves
...
- [**Projeto 1**](https://www.places.education/disciplinas/log_adm/project1/)
- [**Estudos Autônomos** - Nível de serviço logístico](https://www.places.education/disciplinas/log_adm/est_1/)
- [**Estudos Autônomos** - KPI e desempenho logístico](https://www.places.education/disciplinas/log_adm/est_2/)
- [**Estudos Autônomos** - Logística Urbana](https://www.places.education/disciplinas/log_adm/est_3/)
- Revisitar a apresentação de hoje
- Ler e explorar a documentação no site referentes às **UNIDADE 1**, **UNIDADE 2**, **UNIDADE 3**. 

.large[
.center[
**NÃO TEREMOS AULA SEMANA QUE VEM, DIA 29/11!!!!!!**
]
]
